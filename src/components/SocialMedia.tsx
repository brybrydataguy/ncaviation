...
export const socialMediaProfiles = [
  { title: 'Facebook', href: 'https://facebook.com/ncaviation', icon: FacebookIcon },
  { title: 'Instagram', href: 'https://instagram.com/ncaviation', icon: InstagramIcon },
  { title: 'LinkedIn', href: 'https://linkedin.com/company/nc-aviation', icon: LinkedInIcon },
]
